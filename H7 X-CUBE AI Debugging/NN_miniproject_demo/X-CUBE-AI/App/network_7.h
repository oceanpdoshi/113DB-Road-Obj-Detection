...
#ifndef __AI_NETWORK_7_H__
#define __AI_NETWORK_7_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_NETWORK_7_MODEL_NAME          "network_7"

#define AI_NETWORK_7_ACTIVATIONS_ALIGNMENT   (4)

#define AI_NETWORK_7_IN_NUM       (1)
#define AI_NETWORK_7_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 200, 200, 3, 1, NULL), \
}
#define AI_NETWORK_7_IN_SIZE { \
  (200 * 200 * 3), \
}
#define AI_NETWORK_7_IN_1_SIZE  (200 * 200 * 3)
#define AI_NETWORK_7_IN_1_SIZE_BYTES  ((200 * 200 * 3) * 4)





#define AI_NETWORK_7_OUT_NUM      (1)
#define AI_NETWORK_7_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 12, 12, 18, 1, NULL), \
}
#define AI_NETWORK_7_OUT_SIZE { \
  (12 * 12 * 18), \
}
#define AI_NETWORK_7_OUT_1_SIZE  (12 * 12 * 18)
#define AI_NETWORK_7_OUT_1_SIZE_BYTES  ((12 * 12 * 18) * 4)

#define AI_NETWORK_7_N_NODES (74)
 ...
 * @ref ai_network_7_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_7_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_7_*
 * defines into file @ref network_7.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_7_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_NETWORK_7_H__*/
