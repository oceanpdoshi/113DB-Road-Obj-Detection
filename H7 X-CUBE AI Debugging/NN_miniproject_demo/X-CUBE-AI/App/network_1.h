...
#define AI_NETWORK_1_IN_1_SIZE_BYTES  ((128 * 128 * 3) * 4)
...
#define AI_NETWORK_1_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 4, 4, 255, 1, NULL), \
}
#define AI_NETWORK_1_OUT_SIZE { \
  (4 * 4 * 255), \
}
#define AI_NETWORK_1_OUT_1_SIZE  (4 * 4 * 255)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  ((4 * 4 * 255) * 4)

#define AI_NETWORK_1_N_NODES (97)
