...
# TODO - make images black and white but with better resolution

# Desired image size and categories
new_w, new_h = 320, 320
catNms = ['car', 'bicycle', 'motorcycle', 'bus', 'truck', 'traffic light', 'stop sign', 'parking meter', 'fire hydrant']
area_suppression_factor = 35*35 # (pixels^2) : qualitatively, 25x25 seems like a good threshold for 200x200 images
coco = COCO(annFile)
...
imgIds = set(imgIds) # Get all unique images
imgIds = list(imgIds)
